 ...
 */
public class sap_testProducer extends DefaultProducer {
    private static final transient Logger LOG = LoggerFactory.getLogger(sap_testProducer.class);
    private sap_testEndpoint endpoint;

	public sap_testProducer(sap_testEndpoint endpoint) {
        super(endpoint);
