 ...
 */
public class sap_testConsumer extends ScheduledPollConsumer {
    private Logger LOG = LoggerFactory.getLogger(sap_testConsumer.class);

    private final sap_testEndpoint endpoint;


    public sap_testConsumer(final sap_testEndpoint endpoint, final Processor processor) {
