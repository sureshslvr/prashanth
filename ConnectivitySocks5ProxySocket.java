...
public class ConnectivitySocks5ProxySocket extends Socket {
   ...
   // private static final String SOCKS5_PROXY_PORT_PROPERTY = "onpremise_socks5_proxy_port";
    ...
    context.setConnectionType(ConnectionType.HTTP);
   	...
   	String proxyAuthorizationValue = additionalHeaders.get("Proxy-Authorization");
   	String proxyAuthorizationValueWithoutBearer = proxyAuthorizationValue.replace("Bearer ", "");
