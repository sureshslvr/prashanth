 ...
 */
public class Dm1Consumer extends ScheduledPollConsumer {
    private Logger LOG = LoggerFactory.getLogger(Dm1Consumer.class);

    private final Dm1Endpoint endpoint;


    public Dm1Consumer(final Dm1Endpoint endpoint, final Processor processor) {
