 ...
 */
public class Dm1Producer extends DefaultProducer {
    private static final transient Logger LOG = LoggerFactory.getLogger(Dm1Producer.class);
    private Dm1Endpoint endpoint;

	public Dm1Producer(Dm1Endpoint endpoint) {
        super(endpoint);
